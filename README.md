...
**v0.2 active.** V02-00 and V02-01 are complete; Wave 1 continues with constraint and index introspection in V02-02. The milestone adds deliberately small schema-management capabilities behind an opt-in admin boundary. See [docs/v0.2-scope.md](docs/v0.2-scope.md), [docs/v0.2-architecture.md](docs/v0.2-architecture.md), and [docs/v0.2-implementation-plan.md](docs/v0.2-implementation-plan.md). Progress is tracked on the [project wiki](docs/project/index.html).
